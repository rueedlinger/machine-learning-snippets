...
```
    ...
    <matplotlib.legend.Legend at 0x123571fa0>
...
```
    ...
    <matplotlib.legend.Legend at 0x12342ed60>
...
```
    ...
    <matplotlib.legend.Legend at 0x125723fd0>
...
```
    ...
    <mpl_toolkits.mplot3d.art3d.Path3DCollection at 0x125938c40>
