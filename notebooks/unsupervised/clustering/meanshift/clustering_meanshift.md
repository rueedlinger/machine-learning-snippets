...
```
    ...
    <matplotlib.legend.Legend at 0x1287f9a00>
...
```
    ...
    <mpl_toolkits.mplot3d.art3d.Path3DCollection at 0x1286d7310>
...
```
    ...
    <matplotlib.legend.Legend at 0x128cf2be0>
...
```
    ...
    <matplotlib.legend.Legend at 0x128e39970>
